...
contract EmergencyKyberFeeHandler is IKyberFeeHandler, PermissionGroups3, ReentrancyGuard, Utils5 {
    ...
    function withdraw(address payable sendTo, uint256 amount) external nonReentrant onlyAdmin {
    ...
    function setNetworkContract(address _kyberNetwork) external onlyAdmin {
